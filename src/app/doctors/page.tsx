        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {doctors.map((doctor) => (
              <Card
                key={doctor.name}
                className="overflow-hidden card-hover border-t-4 border-t-primary/20 group"
              >
                <div className="relative h-56 overflow-hidden bg-gradient-to-br from-primary/15 to-accent/15">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(11,107,203,0.06),transparent_70%)]" />
                  <Image
                    src={doctor.image}
