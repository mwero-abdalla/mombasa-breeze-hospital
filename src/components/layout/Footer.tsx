        ...
        <div className="section-rhythm grid gap-12 md:grid-cols-2 lg:grid-cols-4">
              ...
              {[
                ...
                <a
                  ...
                  className={cn(
                    ...
                    "bg-card/50 text-muted-foreground/70",
                    "transition-colors hover:bg-warm-sand/20 hover:text-warm-sand",
                  )}
                  aria-label={label}
                >
          ...
          <nav className="lg:col-span-1 space-y-4" aria-label="Quick Links">
            <h3
              ...
              className="text-sm font-semibold tracking-wider uppercase text-card-foreground"
            >
              Quick Links
            </h3>
          ...
          >
            ...
            <div className="flex items-start gap-3">
              <MapPin
                className="size-4 mt-0.5 flex-shrink-0 text-warm-sand/80"
                aria-hidden="true"
              />
              <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <a
                ...
                className="text-sm text-muted-foreground hover:text-warm-sand transition-colors"
              >
                {siteConfig.email}
              </a>
            </div>
            ...
            <div className="space-y-4">
              <a
                ...
                className={cn(
                  ...
                  "bg-coral-pulse px-4 py-3 text-sm font-semibold text-coral-pulse-foreground",
                  "shadow-sm shadow-coral-pulse/30 transition-all",
                  "hover:bg-coral-pulse/90 hover:shadow-coral-pulse/40",
                )}
              >
              ...
              <div className="pt-4 border-t border-border/30 space-y-2">
                <div className="flex items-center gap-2 rounded-full border border-warm-sand/30 bg-warm-sand/10 px-3 py-1">
                  <ShieldCheck
                    className="size-3 text-warm-sand"
                    aria-hidden="true"
                  />
                ...
                <div className="flex items-center gap-2 rounded-full border border-warm-sand/30 bg-warm-sand/10 px-3 py-1">
                  <Heart
                    className="size-3 text-coral-pulse"
                    aria-hidden="true"
                  />
                  <div className="flex flex-col">
